  ...
  const experiences = [
    {
      ...
      location: "Remote",
      description:
        "Leading technical projects and developing full-stack solutions for enterprise clients. Managing cross-functional teams and implementing agile methodologies to deliver high-quality software solutions.",
      highlights: [
    ...
    },
    {
      ...
      location: "Remote",
      description:
        "Developed and maintained web applications using React, Node.js, and Express.js. Collaborated with design and product teams to deliver high-quality solutions that enhanced user experience.",
      highlights: [
    ...
    },
    {
      ...
      position: "Frontend Engineer & Technical Project Manager",
      period: "Jan 2023 - Sep 2025",
      location: "Lagos, Nigeria",
      description:
        "Specialized in frontend development with React.js and modern CSS frameworks. Created engaging user interfaces and improved user experience across multiple projects with a focus on accessibility and performance.",
      highlights: [
    ...
    },
    {
      ...
      location: "Remote",
      description:
        "Focused on backend development using Django and FastAPI. Designed database schemas and implemented secure authentication systems for financial technology applications.",
      highlights: [
        "Built secure payment processing APIs handling transactions",
        "Implemented JWT authentication and role-based access control",
        "Designed database schemas and APIs for financial applications",
        "Collaborated with frontend and product teams on integration",
      ],
      logo: "💳",
    },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <Tabs defaultValue="workcity" className="w-full">
            <TabsList
              className={`grid w-full grid-cols-2 lg:grid-cols-4 mb-6 sm:mb-8 h-auto p-1 ${
                theme === "dark"
            ...
            {experiences.map((exp) => (
              <TabsContent key={exp.id} value={exp.id} className="mt-0">
                ...
                >
                  ...
                  <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4 sm:mb-6 gap-3 sm:gap-4">
                    <div className="flex items-start gap-3 sm:gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <h3
                          className={`mb-1 text-sm sm:text-base ${theme === "dark" ? "text-white" : "text-gray-900"}`}
                        >
                          {exp.company}
                        </h3>
                        <p className="text-cyan-500 mb-2 text-xs sm:text-sm">
                          {exp.position}
                        </p>
                        <div className="flex flex-col gap-1.5 sm:gap-2">
                          <div
                            className={`flex items-center gap-1.5 sm:gap-2 ${theme === "dark" ? "text-gray-400" : "text-gray-600"}`}
                          >
                  ...
                  {/* Description */}
                  <p
                    className={`mb-4 sm:mb-6 text-sm sm:text-base ${theme === "dark" ? "text-gray-400" : "text-gray-700"}`}
                  >
                    {exp.description}
                  </p>
                  ...
                  <div>
                    <h4
                      className={`mb-3 sm:mb-4 text-sm sm:text-base ${theme === "dark" ? "text-cyan-400" : "text-cyan-600"}`}
                    >
                      Key Achievements
                    </h4>
                    <ul className="space-y-2 sm:space-y-3">
                      {exp.highlights.map((highlight, i) => (
                        ...
                        >
                          <span className="text-cyan-400 flex-shrink-0 mt-0.5 sm:mt-1">
                            ▸
                          </span>
